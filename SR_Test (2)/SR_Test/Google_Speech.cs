...
namespace GoogleSpeech
{
    ...
    public class Recognize
    {
        ...
        public static string StreamingMicRecognizeAsyncFunc(int time)
        {
            return StreamingMicRecognizeAsync(time).Result.ToString();
        }
        ...
        {
            string result;
            result = StreamingMicRecognizeAsync(3).Result.ToString();
